...
public class _GScanner {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_INT.withName("max_parse_errors"),
        gst_min_h.C_INT.withName("parse_errors"),
        gst_min_h.C_POINTER.withName("input_name"),
        gst_min_h.C_POINTER.withName("qdata"),
        gst_min_h.C_POINTER.withName("config"),
        gst_min_h.C_INT.withName("token"),
        MemoryLayout.paddingLayout(4),
        _GTokenValue.layout().withName("value"),
        gst_min_h.C_INT.withName("line"),
        gst_min_h.C_INT.withName("position"),
        gst_min_h.C_INT.withName("next_token"),
        MemoryLayout.paddingLayout(4),
        _GTokenValue.layout().withName("next_value"),
        gst_min_h.C_INT.withName("next_line"),
        gst_min_h.C_INT.withName("next_position"),
        gst_min_h.C_POINTER.withName("symbol_table"),
        gst_min_h.C_INT.withName("input_fd"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("text"),
        gst_min_h.C_POINTER.withName("text_end"),
        gst_min_h.C_POINTER.withName("buffer"),
        gst_min_h.C_INT.withName("scope_id"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("msg_handler")
    ).withName("_GScanner");
