...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_INT.withName("tm_sec"),
        gst_min_h.C_INT.withName("tm_min"),
        gst_min_h.C_INT.withName("tm_hour"),
        gst_min_h.C_INT.withName("tm_mday"),
        gst_min_h.C_INT.withName("tm_mon"),
        gst_min_h.C_INT.withName("tm_year"),
        gst_min_h.C_INT.withName("tm_wday"),
        gst_min_h.C_INT.withName("tm_yday"),
        gst_min_h.C_INT.withName("tm_isdst")
    ).withName("tm");
