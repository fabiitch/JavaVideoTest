 ...
 * }
 */
public class GstVideoTimeCodeMeta {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        _GstVideoTimeCode.layout().withName("tc")
    ).withName("$anon$389:9");
    ...
    private static final GroupLayout tc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("tc"));
     ...
     * }
     */
    public static final GroupLayout tc$layout() {
        return tc$LAYOUT;
    }

    private static final long tc$OFFSET = $LAYOUT.byteOffset(groupElement("tc"));
     ...
     * }
     */
    public static final long tc$offset() {
        return tc$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment tc(MemorySegment struct) {
        return struct.asSlice(tc$OFFSET, tc$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void tc(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, tc$OFFSET, tc$LAYOUT.byteSize());
    }
