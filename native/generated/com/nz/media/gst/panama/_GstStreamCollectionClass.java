 ...
 *     void (*stream_notify)(GstStreamCollection *, GstStream *, GParamSpec *);
 *     gpointer _gst_reserved[4];
 * }
 * }
 */
public class _GstStreamCollectionClass {

    _GstStreamCollectionClass() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstObjectClass.layout().withName("parent_class"),
        gst_min_h.C_POINTER.withName("stream_notify"),
        MemoryLayout.sequenceLayout(4, gst_min_h.C_POINTER).withName("_gst_reserved")
    ).withName("_GstStreamCollectionClass");
     ...
     * }
     */
    public final static class stream_notify {

        private stream_notify() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(stream_notify.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(stream_notify.Function fi, Arena arena) {
    ...
    private static final AddressLayout stream_notify$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("stream_notify"));
     ...
     * }
     */
    public static final AddressLayout stream_notify$layout() {
        return stream_notify$LAYOUT;
    }

    private static final long stream_notify$OFFSET = $LAYOUT.byteOffset(groupElement("stream_notify"));
     ...
     * }
     */
    public static final long stream_notify$offset() {
        return stream_notify$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment stream_notify(MemorySegment struct) {
        return struct.get(stream_notify$LAYOUT, stream_notify$OFFSET);
    }
     ...
     * }
     */
    public static void stream_notify(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(stream_notify$LAYOUT, stream_notify$OFFSET, fieldValue);
    }
