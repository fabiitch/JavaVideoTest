 ...
 *     void (*message)(GstBus *, GstMessage *);
 *     void (*sync_message)(GstBus *, GstMessage *);
 *     gpointer _gst_reserved[4];
 * }
 * }
 */
public class _GstBusClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("message"),
        gst_min_h.C_POINTER.withName("sync_message"),
        MemoryLayout.sequenceLayout(4, gst_min_h.C_POINTER).withName("_gst_reserved")
    ).withName("_GstBusClass");
    ...
    public final static class message {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(message.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(message.Function fi, Arena arena) {
     ...
     * }
     */
    public final static class sync_message {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(sync_message.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(sync_message.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout sync_message$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("sync_message"));
     ...
     * }
     */
    public static final AddressLayout sync_message$layout() {
        return sync_message$LAYOUT;
    }

    private static final long sync_message$OFFSET = $LAYOUT.byteOffset(groupElement("sync_message"));
     ...
     * }
     */
    public static final long sync_message$offset() {
        return sync_message$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment sync_message(MemorySegment struct) {
        return struct.get(sync_message$LAYOUT, sync_message$OFFSET);
    }
     ...
     * }
     */
    public static void sync_message(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(sync_message$LAYOUT, sync_message$OFFSET, fieldValue);
    }
