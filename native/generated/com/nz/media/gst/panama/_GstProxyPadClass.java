 ...
 * }
 */
public class _GstProxyPadClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, gst_min_h.C_POINTER).withName("_gst_reserved")
    ).withName("_GstProxyPadClass");
    ...
    private static long[] _gst_reserved$DIMS = { 1 };
