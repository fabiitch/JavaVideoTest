...
public class _GHook {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("prev"),
        gst_min_h.C_INT.withName("ref_count"),
        gst_min_h.C_LONG.withName("hook_id"),
    ...
    private static final OfInt hook_id$LAYOUT = (OfInt)$LAYOUT.select(groupElement("hook_id"));
     ...
     * }
     */
    public static final OfInt hook_id$layout() {
     ...
     * }
     */
    public static int hook_id(MemorySegment struct) {
     ...
     * }
     */
    public static void hook_id(MemorySegment struct, int fieldValue) {
