...
public class _GTypeValueTable {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("value_init"),
        gst_min_h.C_POINTER.withName("value_free"),
        gst_min_h.C_POINTER.withName("value_copy"),
        gst_min_h.C_POINTER.withName("value_peek_pointer"),
        gst_min_h.C_POINTER.withName("collect_format"),
        gst_min_h.C_POINTER.withName("collect_value"),
        gst_min_h.C_POINTER.withName("lcopy_format"),
        gst_min_h.C_POINTER.withName("lcopy_value")
