...
public class _GSource {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("callback_data"),
        gst_min_h.C_POINTER.withName("callback_funcs"),
        gst_min_h.C_POINTER.withName("source_funcs"),
        gst_min_h.C_INT.withName("ref_count"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("context"),
        gst_min_h.C_INT.withName("priority"),
        gst_min_h.C_INT.withName("flags"),
        gst_min_h.C_INT.withName("source_id"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("poll_fds"),
