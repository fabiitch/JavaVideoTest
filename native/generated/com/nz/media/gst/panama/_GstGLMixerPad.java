...
public class _GstGLMixerPad {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstGLBaseMixerPad.layout().withName("parent"),
        gst_min_h.C_INT.withName("current_texture"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.sequenceLayout(4, gst_min_h.C_POINTER).withName("_padding")
    ).withName("_GstGLMixerPad");
    ...
    private static final OfInt current_texture$LAYOUT = (OfInt)$LAYOUT.select(groupElement("current_texture"));
     ...
     * }
     */
    public static final OfInt current_texture$layout() {
        return current_texture$LAYOUT;
    }

    private static final long current_texture$OFFSET = $LAYOUT.byteOffset(groupElement("current_texture"));
     ...
     * }
     */
    public static final long current_texture$offset() {
        return current_texture$OFFSET;
    }
     ...
     * }
     */
    public static int current_texture(MemorySegment struct) {
        return struct.get(current_texture$LAYOUT, current_texture$OFFSET);
    }
     ...
     * }
     */
    public static void current_texture(MemorySegment struct, int fieldValue) {
        struct.set(current_texture$LAYOUT, current_texture$OFFSET, fieldValue);
    }
