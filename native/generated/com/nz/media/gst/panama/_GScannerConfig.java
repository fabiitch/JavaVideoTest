...
public class _GScannerConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("cset_skip_characters"),
        gst_min_h.C_POINTER.withName("cset_identifier_first"),
        gst_min_h.C_POINTER.withName("cset_identifier_nth"),
        gst_min_h.C_POINTER.withName("cpair_comment_single"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_INT.withName("padding_dummy")
