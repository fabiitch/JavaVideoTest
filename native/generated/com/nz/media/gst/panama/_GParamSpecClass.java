...
public class _GParamSpecClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("value_is_valid"),
        MemoryLayout.sequenceLayout(3, gst_min_h.C_POINTER).withName("dummy")
    ...
    public final static class value_is_valid {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(value_is_valid.Function.class, "apply", $DESC);
