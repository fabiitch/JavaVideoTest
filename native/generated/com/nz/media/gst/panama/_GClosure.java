...
public class _GClosure {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("marshal"),
        gst_min_h.C_POINTER.withName("data"),
        gst_min_h.C_POINTER.withName("notifiers")
    ).withName("_GClosure");
    ...
    public final static class marshal {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(marshal.Function.class, "apply", $DESC);
