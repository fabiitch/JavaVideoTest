...
public class _GstGLBufferPool {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstBufferPool.layout().withName("bufferpool"),
    ...
    private static final GroupLayout bufferpool$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("bufferpool"));
     ...
     * }
     */
    public static final GroupLayout bufferpool$layout() {
        return bufferpool$LAYOUT;
    }

    private static final long bufferpool$OFFSET = $LAYOUT.byteOffset(groupElement("bufferpool"));
     ...
     * }
     */
    public static final long bufferpool$offset() {
     ...
     * }
     */
    public static MemorySegment bufferpool(MemorySegment struct) {
        return struct.asSlice(bufferpool$OFFSET, bufferpool$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void bufferpool(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, bufferpool$OFFSET, bufferpool$LAYOUT.byteSize());
    }
