 ...
 * }
 */
public class _GstVideoAggregatorParallelConvertPadClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstVideoAggregatorConvertPadClass.layout().withName("parent_class"),
        MemoryLayout.sequenceLayout(4, gst_min_h.C_POINTER).withName("_gst_reserved")
    ).withName("_GstVideoAggregatorParallelConvertPadClass");
