...
public class GTestLogMsg {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_INT.withName("log_type"),
        gst_min_h.C_INT.withName("n_strings"),
        gst_min_h.C_POINTER.withName("strings"),
        gst_min_h.C_INT.withName("n_nums"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("nums")
    ).withName("$anon$687:9");
