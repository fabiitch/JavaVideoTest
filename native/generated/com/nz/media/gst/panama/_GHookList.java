...
public class _GHookList {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_LONG.withName("seq_id"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("hooks"),
        gst_min_h.C_POINTER.withName("dummy3"),
        gst_min_h.C_POINTER.withName("finalize_hook"),
        MemoryLayout.sequenceLayout(2, gst_min_h.C_POINTER).withName("dummy")
    ).withName("_GHookList");
    ...
    private static final OfInt seq_id$LAYOUT = (OfInt)$LAYOUT.select(groupElement("seq_id"));
     ...
     * }
     */
    public static final OfInt seq_id$layout() {
     ...
     * }
     */
    public static int seq_id(MemorySegment struct) {
     ...
     * }
     */
    public static void seq_id(MemorySegment struct, int fieldValue) {
