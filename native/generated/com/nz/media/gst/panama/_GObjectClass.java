...
public class _GObjectClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("construct_properties"),
        gst_min_h.C_POINTER.withName("constructor"),
        gst_min_h.C_POINTER.withName("set_property"),
        gst_min_h.C_POINTER.withName("get_property"),
        gst_min_h.C_POINTER.withName("dispose"),
        gst_min_h.C_POINTER.withName("finalize"),
        gst_min_h.C_POINTER.withName("dispatch_properties_changed"),
        gst_min_h.C_POINTER.withName("notify"),
        gst_min_h.C_POINTER.withName("constructed"),
        gst_min_h.C_LONG_LONG.withName("flags"),
        gst_min_h.C_LONG_LONG.withName("n_construct_properties"),
        gst_min_h.C_POINTER.withName("pspecs"),
        gst_min_h.C_LONG_LONG.withName("n_pspecs"),
        MemoryLayout.sequenceLayout(3, gst_min_h.C_POINTER).withName("pdummy")
    ...
    public final static class constructor {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(constructor.Function.class, "apply", $DESC);
    ...
    public final static class set_property {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(set_property.Function.class, "apply", $DESC);
    ...
    public final static class get_property {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(get_property.Function.class, "apply", $DESC);
    ...
    public final static class dispose {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(dispose.Function.class, "apply", $DESC);
    ...
    public final static class dispatch_properties_changed {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(dispatch_properties_changed.Function.class, "apply", $DESC);
    ...
    public final static class notify {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(notify.Function.class, "apply", $DESC);
    ...
    public final static class constructed {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(constructed.Function.class, "apply", $DESC);
