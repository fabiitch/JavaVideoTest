 ...
 * }
 */
public class _GstVideoAggregator {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstAggregator.layout().withName("aggregator"),
    ...
    private static final GroupLayout aggregator$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("aggregator"));
     ...
     * }
     */
    public static final GroupLayout aggregator$layout() {
        return aggregator$LAYOUT;
    }

    private static final long aggregator$OFFSET = $LAYOUT.byteOffset(groupElement("aggregator"));
     ...
     * }
     */
    public static final long aggregator$offset() {
     ...
     * }
     */
    public static MemorySegment aggregator(MemorySegment struct) {
        return struct.asSlice(aggregator$OFFSET, aggregator$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void aggregator(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, aggregator$OFFSET, aggregator$LAYOUT.byteSize());
    }
