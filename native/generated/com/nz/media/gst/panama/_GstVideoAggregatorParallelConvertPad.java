...
/**
 * {@snippet lang=c :
 * struct _GstVideoAggregatorParallelConvertPad {
 *     GstVideoAggregatorConvertPad parent_instance;
 * }
 * }
 */
public class _GstVideoAggregatorParallelConvertPad {

    _GstVideoAggregatorParallelConvertPad() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstVideoAggregatorConvertPad.layout().withName("parent_instance")
    ).withName("_GstVideoAggregatorParallelConvertPad");
