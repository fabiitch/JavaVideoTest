...
public class _GThreadFunctions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("mutex_new"),
        gst_min_h.C_POINTER.withName("mutex_lock"),
        gst_min_h.C_POINTER.withName("mutex_trylock"),
        gst_min_h.C_POINTER.withName("mutex_unlock"),
        gst_min_h.C_POINTER.withName("mutex_free"),
        gst_min_h.C_POINTER.withName("cond_new"),
        gst_min_h.C_POINTER.withName("cond_signal"),
        gst_min_h.C_POINTER.withName("cond_broadcast"),
        gst_min_h.C_POINTER.withName("cond_wait"),
        gst_min_h.C_POINTER.withName("cond_timed_wait"),
        gst_min_h.C_POINTER.withName("cond_free"),
        gst_min_h.C_POINTER.withName("private_new"),
        gst_min_h.C_POINTER.withName("private_get"),
        gst_min_h.C_POINTER.withName("private_set"),
        gst_min_h.C_POINTER.withName("thread_create"),
        gst_min_h.C_POINTER.withName("thread_yield"),
        gst_min_h.C_POINTER.withName("thread_join"),
        gst_min_h.C_POINTER.withName("thread_exit"),
        gst_min_h.C_POINTER.withName("thread_set_priority"),
        gst_min_h.C_POINTER.withName("thread_self"),
        gst_min_h.C_POINTER.withName("thread_equal")
    ...
    public final static class mutex_new {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(mutex_new.Function.class, "apply", $DESC);
    ...
    public final static class mutex_lock {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(mutex_lock.Function.class, "apply", $DESC);
    ...
    public final static class mutex_trylock {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(mutex_trylock.Function.class, "apply", $DESC);
    ...
    public final static class mutex_unlock {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(mutex_unlock.Function.class, "apply", $DESC);
    ...
    public final static class mutex_free {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(mutex_free.Function.class, "apply", $DESC);
    ...
    public final static class cond_new {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_new.Function.class, "apply", $DESC);
    ...
    public final static class cond_signal {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_signal.Function.class, "apply", $DESC);
    ...
    public final static class cond_broadcast {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_broadcast.Function.class, "apply", $DESC);
    ...
    public final static class cond_wait {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_wait.Function.class, "apply", $DESC);
    ...
    public final static class cond_timed_wait {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_timed_wait.Function.class, "apply", $DESC);
    ...
    public final static class cond_free {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(cond_free.Function.class, "apply", $DESC);
    ...
    public final static class private_new {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(private_new.Function.class, "apply", $DESC);
    ...
    public final static class private_get {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(private_get.Function.class, "apply", $DESC);
    ...
    public final static class private_set {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(private_set.Function.class, "apply", $DESC);
    ...
    public final static class thread_create {
         ...
         */
        public interface Function {
            void apply(MemorySegment _x0, MemorySegment _x1, int _x2, int _x3, int _x4, int _x5, MemorySegment _x6, MemorySegment _x7);
        }
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_create.Function.class, "apply", $DESC);
         ...
         * Invoke the upcall stub {@code funcPtr}, with given parameters
         */
        public static void invoke(MemorySegment funcPtr, MemorySegment _x0, MemorySegment _x1, int _x2, int _x3, int _x4, int _x5, MemorySegment _x6, MemorySegment _x7) {
            try {
    ...
    public final static class thread_yield {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_yield.Function.class, "apply", $DESC);
    ...
    public final static class thread_join {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_join.Function.class, "apply", $DESC);
    ...
    public final static class thread_exit {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_exit.Function.class, "apply", $DESC);
    ...
    public final static class thread_set_priority {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_set_priority.Function.class, "apply", $DESC);
    ...
    public final static class thread_self {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_self.Function.class, "apply", $DESC);
    ...
    public final static class thread_equal {
        ...
        private static final MethodHandle UP$MH = gst_min_h.upcallHandle(thread_equal.Function.class, "apply", $DESC);
