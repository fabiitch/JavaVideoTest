...
public class GTestConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_INT.withName("test_initialized"),
        gst_min_h.C_INT.withName("test_quick"),
        gst_min_h.C_INT.withName("test_perf"),
        gst_min_h.C_INT.withName("test_verbose"),
        gst_min_h.C_INT.withName("test_quiet"),
        gst_min_h.C_INT.withName("test_undefined")
    ).withName("$anon$654:9");
