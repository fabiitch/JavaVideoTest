...
public class _GIOChannel {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_POINTER.withName("funcs"),
        gst_min_h.C_POINTER.withName("encoding"),
        gst_min_h.C_POINTER.withName("read_cd"),
        gst_min_h.C_POINTER.withName("write_cd"),
        gst_min_h.C_POINTER.withName("line_term"),
        gst_min_h.C_INT.withName("line_term_len"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_LONG_LONG.withName("buf_size"),
        gst_min_h.C_POINTER.withName("read_buf"),
        gst_min_h.C_POINTER.withName("encoded_read_buf"),
        gst_min_h.C_POINTER.withName("write_buf"),
        MemoryLayout.sequenceLayout(6, gst_min_h.C_CHAR).withName("partial_write_buf"),
