...
public class _GOptionEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("long_name"),
        gst_min_h.C_CHAR.withName("short_name"),
        MemoryLayout.paddingLayout(3),
        gst_min_h.C_INT.withName("flags"),
        gst_min_h.C_INT.withName("arg"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("arg_data"),
        gst_min_h.C_POINTER.withName("description"),
        gst_min_h.C_POINTER.withName("arg_description")
