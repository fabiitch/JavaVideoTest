...
public class _GStaticRecMutex {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        gst_min_h.C_INT.withName("depth"),
    ...
    public static class unused {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            gst_min_h.C_POINTER.withName("owner"),
            gst_min_h.C_DOUBLE.withName("dummy")
        ).withName("$anon$169:3");
         ...
         * }
         */
        public static MemorySegment owner(MemorySegment union) {
         ...
         * }
         */
        public static void owner(MemorySegment union, MemorySegment fieldValue) {
