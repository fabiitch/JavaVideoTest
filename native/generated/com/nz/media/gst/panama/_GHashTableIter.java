...
public class _GHashTableIter {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_POINTER.withName("dummy1"),
        gst_min_h.C_POINTER.withName("dummy2"),
        gst_min_h.C_POINTER.withName("dummy3"),
        gst_min_h.C_INT.withName("dummy4"),
        gst_min_h.C_INT.withName("dummy5"),
        gst_min_h.C_POINTER.withName("dummy6")
