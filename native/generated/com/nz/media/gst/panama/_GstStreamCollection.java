...
public class _GstStreamCollection {
    ...
    private static final AddressLayout upstream_id$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("upstream_id"));
     ...
     * }
     */
    public static final AddressLayout upstream_id$layout() {
        return upstream_id$LAYOUT;
    }

    private static final long upstream_id$OFFSET = $LAYOUT.byteOffset(groupElement("upstream_id"));
     ...
     * }
     */
    public static final long upstream_id$offset() {
        return upstream_id$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment upstream_id(MemorySegment struct) {
        return struct.get(upstream_id$LAYOUT, upstream_id$OFFSET);
    }
     ...
     * }
     */
    public static void upstream_id(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(upstream_id$LAYOUT, upstream_id$OFFSET, fieldValue);
    }
