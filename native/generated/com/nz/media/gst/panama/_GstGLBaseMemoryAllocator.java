 ...
 * }
 */
public class _GstGLBaseMemoryAllocator {

    _GstGLBaseMemoryAllocator() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GstAllocator.layout().withName("parent"),
        gst_min_h.C_POINTER.withName("fallback_mem_copy"),
        MemoryLayout.sequenceLayout(4, gst_min_h.C_POINTER).withName("_padding")
    ).withName("_GstGLBaseMemoryAllocator");
    ...
    private static final AddressLayout fallback_mem_copy$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("fallback_mem_copy"));
     ...
     * }
     */
    public static final AddressLayout fallback_mem_copy$layout() {
        return fallback_mem_copy$LAYOUT;
    }

    private static final long fallback_mem_copy$OFFSET = $LAYOUT.byteOffset(groupElement("fallback_mem_copy"));
     ...
     * }
     */
    public static final long fallback_mem_copy$offset() {
        return fallback_mem_copy$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment fallback_mem_copy(MemorySegment struct) {
        return struct.get(fallback_mem_copy$LAYOUT, fallback_mem_copy$OFFSET);
    }
     ...
     * }
     */
    public static void fallback_mem_copy(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(fallback_mem_copy$LAYOUT, fallback_mem_copy$OFFSET, fieldValue);
    }
