...
public class _GSignalQuery {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gst_min_h.C_INT.withName("signal_id"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("signal_name"),
        gst_min_h.C_LONG_LONG.withName("itype"),
        gst_min_h.C_INT.withName("signal_flags"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_LONG_LONG.withName("return_type"),
        gst_min_h.C_INT.withName("n_params"),
        MemoryLayout.paddingLayout(4),
        gst_min_h.C_POINTER.withName("param_types")
